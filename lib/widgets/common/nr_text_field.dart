        ...
        children: [
          TextField(
                decoration: InputDecoration(
                  ...
                  counterStyle: TextStyle(fontFamily: 'SmallCapsMC', color: NoRiskClientColors.text, fontSize: 10),
                ),
                minLines: 1,
                enabled: true,
                maxLines: 5,
                ...
                cursorHeight: 10,
                style: TextStyle(fontFamily: 'SmallCapsMC', color: NoRiskClientColors.text, fontSize: 12.5, height: 0.5),
