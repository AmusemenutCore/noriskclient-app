                  ...
                  Row(children: [
                    ...
                    NoRiskButton(
                        ...
                        child: Padding(
                          ...
                          child: NRIcons.svg('like',
                              color: ownRating == true ? Colors.green : NoRiskClientColors.text,
                              size: 18),
                        )),
                    const SizedBox(width: 5),
                    NoRiskButton(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(5),
                          child: NRIcons.svg('dislike',
                              color: ownRating == false ? Colors.red : NoRiskClientColors.text,
                              size: 18),
                        )),
                    const SizedBox(width: 5),
                    NoRiskIconButton(
                        onTap: reply,
                        icon: NRIcons.svg('comment',
                            color: NoRiskClientColors.textLight, size: 20)),
                      if (!ownComment) const SizedBox(width: 10),
                if (!ownComment)
                  NoRiskIconButton(
                      onTap: report,
                      icon: NRIcons.svg('flag',
                          color: Colors.red, size: 20)),
                      const SizedBox(width: 7.5),
                if (ownComment)
                  NoRiskIconButton(
                      onTap: delete,
                      icon: NRIcons.svg('trashcan',
